...
CREATE TABLE `testimoniales` (
  ...
  UNIQUE KEY `testimoniales_id_primary` (`id`) USING BTREE,
  UNIQUE KEY `id` (`id`)
...
INSERT INTO `testimoniales` VALUES (4,'Luis','targetooldm@gmail.com','Mi primera tabla gracias dios'),(5,'Luis','targetooldm@gmail.com','Mi primera tabla gracias dios'),(6,'Pedro','pedro@pedro.com','Buena agencia'),(7,'Nuevo','nuevo@nuevo.com','Muy buenas vacaciones');
...
-- Dump completed on 2021-01-14 21:48:35
